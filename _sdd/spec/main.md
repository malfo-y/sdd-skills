...
- Codex에서 16개 스킬(discussion, git, sdd-upgrade 제외)이 정상 동작
...
│
├── .codex/
│   └── skills/                  # Codex 스킬 (17개, discussion 제외 시 16개 기능)
│       └── (위와 유사 구조, git·sdd-upgrade 제외)
│
...
| 스킬 수 | 19개 | 17개 (discussion 제외 시 16개 기능) |
