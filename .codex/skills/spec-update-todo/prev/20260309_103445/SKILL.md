...
6. add/merge `Open Questions` for unresolved assumptions
7. update `DECISION_LOG.md` only if the planned direction introduces a meaningful decision
8. update version/date/changelog only if the current spec already uses them
