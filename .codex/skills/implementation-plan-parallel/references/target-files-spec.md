...
> 참고: 이 규칙은 **파일 수준 최소 안전장치**입니다.
> 파일이 겹치지 않아도 공유 스키마/공용 설정/API 계약 의존으로 의미적 충돌이 발생할 수 있습니다.
> 실행 단계에서는 `implementation-parallel/references/parallel-execution.md`의 의미적 충돌 규칙을 함께 적용합니다.
...
`implementation-parallel` 스킬은 이 경우 다음과 같이 처리합니다:
