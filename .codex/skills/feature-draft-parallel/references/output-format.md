...
Detailed format specification for the `feature-draft-parallel` skill's output files.
This extends the `feature-draft` output format with **Target Files** fields in Part 2.
...
- **Sequential**: Run `implementation` skill → use Part 2 as plan (Target Files ignored)
