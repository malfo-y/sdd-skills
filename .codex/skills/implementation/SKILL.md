...
```
spec -> feature-draft / implementation-plan -> implementation (this) -> spec-update-done
```
...
- Upstream plans: `feature-draft` (Part 2), `implementation-plan`
