...
- `implementation`: `impl_default` -> `gpt-5.5 / medium`
- `implementation_review`: `review_default` -> `gpt-5.5 / medium`
- `spec_update_done`: `spec_sync_default` -> `gpt-5.5 / medium`
...
- `feature_draft_agent`: `draft_strict` -> `gpt-5.5 / high`
- `spec_update_todo`: `spec_sync_default` -> `gpt-5.5 / medium`
- `implementation_plan`: `plan_strict` -> `gpt-5.5 / high`
- `implementation`: `impl_default` -> `gpt-5.5 / medium`
- `implementation_review`: `review_default` -> `gpt-5.5 / medium`
...
- `execution_sequence_per_group`: `[Checkpoint=false phases: light validation only] -> Checkpoint=true phase implementation -> implementation_review -> implementation (if needed) -> implementation_review -> group validation`
