...
- `feature_draft`: `draft_strict` -> `gpt-5.5 / xhigh`
- `implementation`: `impl_default` -> `gpt-5.5 / high`
- `implementation_review`: `review_default` -> `gpt-5.5 / high`
...
**Execution profile**: `draft_strict` (`gpt-5.5 / xhigh`)
...
**Execution profile**: `impl_default` (`gpt-5.5 / high`)
**입력 파일**:
...
- `review_profile`: `review_default` -> `gpt-5.5 / high`
- `fix_profile`: `impl_default` -> `gpt-5.5 / high`
...
- `implementation_plan`: `plan_strict` -> `gpt-5.5 / xhigh`
- `implementation`: `impl_default` -> `gpt-5.5 / high`
- `implementation_review`: `review_default` -> `gpt-5.5 / high`
- `final_integration_review`: `review_integration_strict` -> `gpt-5.5 / xhigh` (그룹 2개 이상일 때만 사용; 그룹 1개면 마지막 group gate가 final을 겸하므로 이 profile은 적용되지 않음)
- `spec_update_done`: `spec_sync_default` -> `gpt-5.5 / medium`
...
**Execution profile**: `plan_strict` (`gpt-5.5 / xhigh`)
**입력 파일**:
- `_sdd/drafts/2026-04-10_feature_draft_payment_system.md`
- `_sdd/spec/main.md`
...
- `final_integration_review_profile`: `review_integration_strict` -> `gpt-5.5 / xhigh`
