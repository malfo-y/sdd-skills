...
Use the default, most capable Codex model (e.g. `gpt-5.3-codex`) to review the implementation unless the user specifies otherwise.
...
Do not modify implementation plan documents in this skill. Record suggested plan/status updates in the review report for follow-up execution.
