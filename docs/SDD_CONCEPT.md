...
| Layer | 역할 | 담는 것 |
|------|------|---------|
| Harness (AGENTS.md + 훅 자산) | repo 작업 규약(how) / 작업 진입 | 작업 원칙, 읽는 순서, 검증 표준, 워크플로우 단계 순서, 판단 기준 포인터, 그리고 그 규약을 강제하는 실행 자산 |
