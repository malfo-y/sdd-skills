...
- 특정 변경의 touchpoint / target file / validation detail: temporary spec
...
`Strategic Code Map`은 stale 가능성이 있는 힌트다. feature planning과 implementation은 반드시 현재 코드 탐색으로 `Touchpoints`와 `Target Files`를 재확인해야 한다.
