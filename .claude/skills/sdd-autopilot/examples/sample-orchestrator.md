...
- `agent_mapping`: `review = implementation-review (model: opus)`, `fix = implementation (model: sonnet)`, `re-review = implementation-review (model: opus)`
...
- `agent_mapping`:
  - `review = implementation-review (model: opus)`
  - `fix = implementation (model: sonnet)`
  - `re-review = implementation-review (model: opus)`
- `execution_sequence_per_group`: `[Checkpoint=false phases: light validation only] -> Checkpoint=true phase implementation -> implementation-review -> implementation (if needed) -> implementation-review -> group validation`
