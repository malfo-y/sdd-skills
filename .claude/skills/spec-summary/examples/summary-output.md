...
| Temporary execution model | `.codex/skills/feature-draft-lite/SKILL.md`, `.codex/skills/implementation-lite/SKILL.md`, `.codex/skills/implementation-review/SKILL.md` | 계획, 실행, 리뷰가 어떤 skill로 이어지는지 드러낸다 |
...
- how to use or read this project:
  ...
  - `/feature-draft-lite`로 temporary spec과 구현 범위를 고정한다.
  - `/implementation-lite`와 `/implementation-review`로 실행과 검증을 닫는다.
