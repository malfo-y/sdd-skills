...
```
Agent(subagent_type="write-skeleton", prompt="IMPLEMENTATION_PLAN.md 작성. [Output Format + 수집 정보]")
```
...
```
Agent(subagent_type="write-skeleton", prompt="IMPLEMENTATION_PLAN.md 인덱스 작성. Overview/Scope/Components/Phase 요약 + Phase 파일 링크")
```
