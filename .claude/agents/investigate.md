---
name: investigate
description: "Internal agent. Called explicitly by other agents or skills via Agent(subagent_type=investigate). Systematic debugging -- find root cause, fix it, verify the fix."
